...
interface Props {
    ...
    alarm: Alarm | null
    onClose: () => void
    onSubmit: (id: string, name: string, interval: number) => Promise<void>
}

export default function EditAlarmModal({ visible, alarm, onClose, onSubmit }: Props) {
    ...
    const handleSubmit = async () => {
        ...
        setSaving(true)
        await onSubmit(alarm.id, name.trim(), parseInt(interval, 10))
        setSaving(false)
        onClose()
    }
